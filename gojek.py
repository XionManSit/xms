...
\ \/ (_) ___  _ __ |  \/  | __ _ _ __ / ___|(_) |_
 \  /| |/ _ \| '_ \| |\/| |/ _` | '_ \\___ \| | __|
 /  \| | (_) | | | | |  | | (_| | | | |___) | | |_
/_/\_\_|\___/|_| |_|_|  |_|\__,_|_| |_|____/|_|\__|                                                           
"""
...
try:
  ...
  list_operator = ["xl", "axis", "indosat", "smartfren", "telkomsel", "three"]
  ...
  os.system(f'title Gojek Creator {ver}')
  # check()
  clear()
  print(art)
  print("#############################")
  print("# Created by : XionManSit   #")
  print(f"# Your IP : {ip}  #")
  print("#############################")
  print()
  print("   Auto Registrasi Gojek ")
  print()
  print("1. Lanjut")
  print("2. Keluar")
  print()
